...
public interface UserMapper {
	 ...
	 * @mbg.generated
	 */
	User selectOneByExampleSelective(@Param("example") UserExample example,
			@Param("selective") User.Column... selective);
	 ...
	 * @mbg.generated
	 */
	List<User> selectByExampleSelective(@Param("example") UserExample example,
			@Param("selective") User.Column... selective);
	 ...
	 * @mbg.generated
	 */
	User selectByPrimaryKeySelective(@Param("uid") Integer uid,
			@Param("selective") User.Column... selective);
