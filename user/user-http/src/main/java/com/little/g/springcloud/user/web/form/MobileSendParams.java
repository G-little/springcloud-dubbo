...
import com.little.g.springcloud.common.validate.annatations.SmsType;
import org.hibernate.validator.constraints.Length;

import javax.validation.constraints.NotNull;

/**
 * User: erin Date: 14-10-17 Time: 下午4:16
 */
public class MobileSendParams extends BaseMobileParams {
	...
	public String toString() {
		return "MobileSendParams{" + "captcha='" + captcha + '\'' + ", code='" + code
				+ '\'' + ", smsType=" + smsType + ", interfaceType=" + interfaceType
				+ ", ct=" + ct + ", loginVersion=" + loginVersion + '}';
	}
