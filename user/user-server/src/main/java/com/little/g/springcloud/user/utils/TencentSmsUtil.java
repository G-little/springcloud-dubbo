package com.little.g.springcloud.user.utils;
...
public class TencentSmsUtil {
	...
	private static SmsSingleSender ssender = new SmsSingleSender(appid, appkey,
			httpclient);
	...
	public static String sendSms(String nationCode, String mobile, Integer templateId,
			String[] params) {
		...
		try {
			...
			if (StringUtils.isNotEmpty(result.errMsg)) {
				log.error("send msg error result:{}",
