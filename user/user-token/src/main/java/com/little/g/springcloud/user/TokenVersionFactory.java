...
/**
 * token版本控制工厂类 User: erin Date: 14-10-30 Time: 下午5:34
 */
public class TokenVersionFactory {
	...
	protected static ConcurrentMap<String, TokenVersionConfig> versionMap = Maps
			.newConcurrentMap();
	...
	private static synchronized TokenVersionConfig newResource(String resourceName,
			String versionStr) {
		properties = new Props();
		InputStream input = TokenVersionConfig.class.getClassLoader()
