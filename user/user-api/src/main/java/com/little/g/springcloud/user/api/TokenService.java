...
public interface TokenService {
	 ...
	 * @return
	 */
	UserDeviceTokenDTO createToken(@NotBlank @Min(1) Long uid,
	 ...
	 * @return
	 */
	TokenCache verify(@NotBlank @Size(min = 3, max = 50) String deviceId,
	 ...
	 * @return
	 */
	UserDeviceTokenDTO refreshToken(@NotBlank @Min(1) Long uid,
			@NotBlank @Size(min = 3, max = 50) String deviceId, @NotBlank Byte deviceType,
	 ...
	 * @return
	 */
	boolean logout(@NotBlank @Min(1) Long uid,
			@NotBlank @Size(min = 3, max = 50) String deviceId, @NotBlank Byte deviceType,
			@Size(min = 1, max = 100) String os);
