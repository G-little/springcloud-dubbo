package com.little.g.springcloud.common.exception;

/**
 * SOA层发生业务数据不合法时抛出此异常. Created by keysilence on 14-10-20.
 *
 * optimize 'default message is code' modify by chris.wang 2016-05-17
 */
