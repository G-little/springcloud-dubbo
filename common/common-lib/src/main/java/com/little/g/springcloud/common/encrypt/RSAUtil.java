...
/**
 * User: Echo Liu Date: 16/10/24 Time: 下午5:52
 */
public class RSAUtil {
	...
	public static void main(String[] args) {
		...
		String data = "1000243r3454323543r24653fery65ytgfh";
		...
		try {
			Boolean verify = verify(data.getBytes(), getPublicKey(map), sign);
			System.out.println("解密:" + verify);
		}
		catch (Exception e) {
			e.printStackTrace();
		}
