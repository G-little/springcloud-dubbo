...
/**
 * 手机号工具类 User: erin Date: 14-10-16 Time: 下午2:50
 */
public class PhoneUtil {
	...
	/**
	 * 验证手机号码、电话号码是否有效 新联通 （中国联通+中国网通）手机号码开头数字 130、131、132、145、155、156、185、186 新移动
	 * （中国移动+中国铁通）手机号码开头数字
	 * 134、135、136、137、138、139、147、150、151、152、157、158、159、182、183、187、188 新电信 （中国电信
	 * <http: baike.baidu.com/view/3214.htm>+中国卫通）手机号码开头数字 133、153、189、180、181
	 */
	...
	public static boolean verifyNationalNumber(String phone, String countryCode) {
		...
		return formatNationalMobile(phone, region) || ("CN".equals(region)
				&& !Strings.isNullOrEmpty(phone) && phone.matches(PHONE_FORMAT));
	}
	...
	public static void main(String[] args) {
		...
		// }
		//
		// String MOBILE_FORMAT_MATCHER =
		// "(?:\\(?[0\\+]?\\d{1,3}\\)?)[\\s-]?(?:0|\\d{1,4})[\\s-]?(?:(?:13\\d{9})|(?:\\d{7,8}))";
		//
		// //String mobile = "003-626-2287211";
		// System.out.println(mobile.matches(MOBILE_FORMAT_MATCHER));
		//
		// String[] phones = new String[]{"1523620111", "11011363254", "15811363254",
		// "15811364216", "15811364216",
		// "13011111111", "15811364216", "022-6232903-22", "022-6232903",
		// "+8615811364216", "8615811224181", "17043123221", "007-007972", "17701450908"};
