...
public class RegexUtil {
	 ...
	 * <p>
	 * china mobile: 134(0-8), 135, 136, 137, 138, 139, 147, 150, 151, 152, 157, 158, 159,
	...
	/**
	 * Replace the first subsequence of the input sequence that matches the regex with the
	 * given replacement string.
	 * @param input The input.
	 * @param regex The regex.
	 * @param replacement The replacement string.
	 * @return the string constructed by replacing the first matching subsequence by the
	...
	/**
	 * Replace every subsequence of the input sequence that matches the pattern with the
	 * given replacement string.
	 * @param input The input.
	 * @param regex The regex.
	 * @param replacement The replacement string.
