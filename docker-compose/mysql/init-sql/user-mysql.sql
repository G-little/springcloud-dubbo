...
# Database: springcloud-user
# Generation Time: 2020-05-24 09:53:58 +0000
# ************************************************************
...
INSERT INTO `user` (`uid`, `avatar`, `name`, `gender`, `birthday`, `status`, `mobile`, `create_time`, `update_time`)
VALUES
	(11443,'/c/d/e','赵六',1,153000000,0,'15201008961',1590149492786,1590149538735);
...
INSERT INTO `user_device_token` (`id`, `uid`, `device_id`, `device_type`, `os`, `access_token`, `access_expires_in`, `refresh_token`, `refresh_expires_in`, `create_time`, `update_time`)
VALUES
	(2,11443,'A15201008961',1,NULL,'Al7JLSsCLLOPzvBZ9B2Tfov0',1592834603009,'Al7JLSwCLLPbf9AOpAuX6ETc',1595426603009,NULL,NULL);
