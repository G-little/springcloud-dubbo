...
public interface PayChannelMapper {
     ...
     * @mbg.generated
     */
    PayChannel selectOneByExampleSelective(@Param("example") PayChannelExample example, @Param("selective") PayChannel.Column ... selective);
     ...
     * @mbg.generated
     */
    List<PayChannel> selectByExampleSelective(@Param("example") PayChannelExample example, @Param("selective") PayChannel.Column ... selective);
     ...
     * @mbg.generated
     */
    PayChannel selectByPrimaryKeySelective(@Param("id") Integer id, @Param("selective") PayChannel.Column ... selective);
