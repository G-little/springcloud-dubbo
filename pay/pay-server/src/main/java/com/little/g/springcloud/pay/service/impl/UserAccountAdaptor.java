...
import com.little.g.springcloud.pay.mapper.UserAccountMapperExt;
...
public class UserAccountAdaptor implements AccountAdaptor<NormalUserAccount> {
	...
	private static final Logger LOGGER = LoggerFactory
			.getLogger(UserAccountAdaptor.class);
	...
	private void doCredit(NormalUserAccount account, long amount, Account to,
			boolean failOnAccountNotFound) {
