...
public interface AccountService {
	 ...
	 * @return
	 */
	List<TransactionRecordDTO> transfer(long fromUid, long toUid, long amount,
	 ...
	 * @return
	 */
	List<TransactionRecordDTO> froze(long uid, long amount, String transNum,
	 ...
	 * @return
	 */
	List<TransactionRecordDTO> unfroze(String srcTransNum, long amount, long toUid,
			String transNum, BusinessType btype, String desc);
