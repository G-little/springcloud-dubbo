...
import com.little.g.springcloud.admin.web.vo.CatVo;
...
public class AdminGoodsManager {
	...
	public Object list(Integer goodsId, String goodsSn, String name, Integer page,
	 ...
	 */
	@Transactional
	public Object update(GoodsAllinoneVo goodsAllinone) {
	...
	@Transactional
	public Object delete(LitemallGoodsDTO goods) {
	...
	@Transactional
	public Object create(GoodsAllinoneVo goodsAllinone) {
		Object error = validate(goodsAllinone);
		if (error != null) {
			return error;
		}
