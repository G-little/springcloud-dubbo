...
public class AdminGoodsController {
    ...
    @GetMapping("/list")
    public ResultJson<Page<LitemallGoodsDTO>> list(Integer goodsId, String goodsSn, String name,
    ...
    @PostMapping("/create")
    public ResultJson<CategoryBrandVo> create(@RequestBody GoodsAllinoneVo goodsAllinone) {
