...
public class AdminBrandController {
	...
	private Object validate(LitemallBrandDTO brand) {
	...
	@PostMapping("/update")
	public Object update(@RequestBody LitemallBrandDTO brand) {
		Object error = validate(brand);
		if (error != null) {
			return error;
		}
	...
	@PostMapping("/delete")
	public Object delete(@RequestBody LitemallBrandDTO brand) {
