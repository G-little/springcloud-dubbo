...
public class LitemallFootprintServiceImpl implements LitemallFootprintService {
    ...
    public LitemallFootprintDTO findById(Integer id) {
        return DTOUtil.convert2T(footprintMapper.selectByPrimaryKey(id),
                LitemallFootprintDTO.class);
    }
    ...
    public LitemallFootprintDTO findById(Integer userId, Integer id) {
        ...
        return DTOUtil.convert2T(footprintMapper.selectOneByExample(example),
                LitemallFootprintDTO.class);
    }
    ...
    public void add(LitemallFootprintDTO footprint) {
        ...
        footprintMapper
                .insertSelective(DTOUtil.convert2T(footprint, LitemallFootprint.class));
    }
