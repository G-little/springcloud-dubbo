...
public class LitemallCategoryServiceImpl implements LitemallCategoryService {
	...
	@Override
	public PageInfo<LitemallCategoryDTO> querySelective(String id, String name, Integer page,
		...
		return DTOUtil.convert2Page(categoryMapper.selectByExample(example),
				LitemallCategoryDTO.class);
	}
