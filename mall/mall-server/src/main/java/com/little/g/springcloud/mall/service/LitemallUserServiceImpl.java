...
public class LitemallUserServiceImpl implements LitemallUserService {
    ...
    public LitemallUserDTO findById(Integer userId) {
        return DTOUtil.convert2T(userMapper.selectByPrimaryKey(userId), LitemallUserDTO.class);
    }
    ...
    public LitemallUserDTO queryByOid(String openId) {
        ...
        return DTOUtil.convert2T(userMapper.selectOneByExample(example), LitemallUserDTO.class);
    }
    ...
    public int updateById(LitemallUserDTO user) {
        user.setUpdateTime(LocalDateTime.now());
        return userMapper.updateByPrimaryKeySelective(DTOUtil.convert2T(user, LitemallUser.class));
    }

    @Override
    public List<LitemallUserDTO> querySelective(String username, String mobile, Integer page, Integer size, String sort, String order) {
        LitemallUserExample example = new LitemallUserExample();
        ...
        return DTOUtil.convert2List(userMapper.selectByExample(example), LitemallUserDTO.class);
    }
