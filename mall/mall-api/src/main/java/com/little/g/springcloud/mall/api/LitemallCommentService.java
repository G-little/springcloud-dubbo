...
public interface LitemallCommentService {
	...
	List<LitemallCommentDTO> query(Byte type, Integer valueId, Integer showType,
	...
	PageInfo<LitemallCommentDTO> querySelective(String userId, String valueId, Integer page,
