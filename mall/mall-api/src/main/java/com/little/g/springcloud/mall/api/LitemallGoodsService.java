...
public interface LitemallGoodsService {
	...
	PageInfo<LitemallGoodsDTO> querySelective(Integer goodsId, String goodsSn, String name,
	...
	List<Integer> getCatIds(Integer brandId, String keywords, Boolean isHot,
			Boolean isNew);
