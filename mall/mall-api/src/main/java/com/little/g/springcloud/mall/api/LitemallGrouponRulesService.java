...
public interface LitemallGrouponRulesService {
    ...
    List<LitemallGrouponRulesDTO> queryList(Integer page, Integer limit, String sort, String order);

    boolean isExpired(LitemallGrouponRulesDTO rules);

    List<LitemallGrouponRulesDTO> querySelective(String goodsId, Integer page, Integer size, String sort, String order);
