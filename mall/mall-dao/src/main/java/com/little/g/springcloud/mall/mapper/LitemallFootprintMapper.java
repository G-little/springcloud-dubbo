...
public interface LitemallFootprintMapper {
	 ...
	 * @mbg.generated
	 */
	LitemallFootprint selectByPrimaryKeySelective(@Param("id") Integer id,
			@Param("selective") LitemallFootprint.Column... selective);
	 ...
	 * @mbg.generated
	 */
	LitemallFootprint selectByPrimaryKeyWithLogicalDelete(@Param("id") Integer id,
	 ...
	 * @mbg.generated
	 */
	int updateByExampleSelective(@Param("record") LitemallFootprint record,
			@Param("example") LitemallFootprintExample example);
	 ...
	 * @mbg.generated
	 */
	int updateByExample(@Param("record") LitemallFootprint record,
			@Param("example") LitemallFootprintExample example);
