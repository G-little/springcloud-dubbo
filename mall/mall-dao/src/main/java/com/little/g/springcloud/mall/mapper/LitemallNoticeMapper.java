...
public interface LitemallNoticeMapper {
	 ...
	 * @mbg.generated
	 */
	LitemallNotice selectByPrimaryKeySelective(@Param("id") Integer id,
			@Param("selective") LitemallNotice.Column... selective);
	 ...
	 * @mbg.generated
	 */
	LitemallNotice selectByPrimaryKeyWithLogicalDelete(@Param("id") Integer id,
	 ...
	 * @mbg.generated
	 */
	int updateByExampleSelective(@Param("record") LitemallNotice record,
			@Param("example") LitemallNoticeExample example);
	 ...
	 * @mbg.generated
	 */
	int updateByExample(@Param("record") LitemallNotice record,
			@Param("example") LitemallNoticeExample example);
