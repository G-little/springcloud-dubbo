...
import com.little.g.springcloud.mall.model.LitemallRegion;
...
public interface LitemallRegionMapper {
     ...
     * @mbg.generated
     */
    LitemallRegion selectByPrimaryKeySelective(@Param("id") Integer id,
                                               @Param("selective") LitemallRegion.Column... selective);
     ...
     * @mbg.generated
     */
    int updateByExampleSelective(@Param("record") LitemallRegion record,
                                 @Param("example") LitemallRegionExample example);
     ...
     * @mbg.generated
     */
    int updateByExample(@Param("record") LitemallRegion record,
                        @Param("example") LitemallRegionExample example);
