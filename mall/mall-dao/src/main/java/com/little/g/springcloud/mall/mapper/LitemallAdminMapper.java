...
import com.little.g.springcloud.mall.model.LitemallAdmin;
import com.little.g.springcloud.mall.model.LitemallAdminExample;
...
public interface LitemallAdminMapper {
     ...
     * @mbg.generated
     */
    LitemallAdmin selectByPrimaryKeySelective(@Param("id") Integer id,
                                              @Param("selective") LitemallAdmin.Column... selective);
     ...
     * @mbg.generated
     */
    LitemallAdmin selectByPrimaryKeyWithLogicalDelete(@Param("id") Integer id,
     ...
     * @mbg.generated
     */
    int updateByExampleSelective(@Param("record") LitemallAdmin record,
                                 @Param("example") LitemallAdminExample example);
     ...
     * @mbg.generated
     */
    int updateByExample(@Param("record") LitemallAdmin record,
                        @Param("example") LitemallAdminExample example);
