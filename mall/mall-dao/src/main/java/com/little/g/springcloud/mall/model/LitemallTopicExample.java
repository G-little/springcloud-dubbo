...
public class LitemallTopicExample {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        protected void addGoodsCriterion(String condition, Object value,
                                         String property) {
            if (value == null) {
                throw new RuntimeException("Value for " + property + " cannot be null");
            }
            goodsCriteria.add(new Criterion(condition, value,
                    "com.little.g.springcloud.mall.mybatis.JsonIntegerArrayTypeHandler"));
            allCriteria = null;
        }

        protected void addGoodsCriterion(String condition, Integer[] value1,
                                         Integer[] value2, String property) {
            if (value1 == null || value2 == null) {
                throw new RuntimeException(
                        "Between values for " + property + " cannot be null");
            }
            goodsCriteria.add(new Criterion(condition, value1, value2,
                    "com.little.g.springcloud.mall.mybatis.JsonIntegerArrayTypeHandler"));
            allCriteria = null;
        }
        ...
        public Criteria andTitleEqualToColumn(LitemallTopic.Column column) {
            addCriterion(new StringBuilder("title = ")
        ...
        public Criteria andSubtitleEqualToColumn(LitemallTopic.Column column) {
            addCriterion(new StringBuilder("subtitle = ")
                    .append(column.getEscapedColumnName()).toString());
            return (Criteria) this;
        }
        ...
        public Criteria andSubtitleGreaterThanOrEqualToColumn(
                LitemallTopic.Column column) {
            addCriterion(new StringBuilder("subtitle >= ")
                    .append(column.getEscapedColumnName()).toString());
            return (Criteria) this;
        }
        ...
        public Criteria andReadCountEqualToColumn(LitemallTopic.Column column) {
            addCriterion(new StringBuilder("read_count = ")
                    .append(column.getEscapedColumnName()).toString());
            return (Criteria) this;
        }
        ...
        public Criteria andReadCountGreaterThanOrEqualToColumn(
                LitemallTopic.Column column) {
            addCriterion(new StringBuilder("read_count >= ")
                    .append(column.getEscapedColumnName()).toString());
            return (Criteria) this;
        ...
        public Criteria andGoodsEqualToColumn(LitemallTopic.Column column) {
            addCriterion(new StringBuilder("goods = ")
                    .append(column.getEscapedColumnName()).toString());
            return (Criteria) this;
        }
    ...
    public static class Criteria extends GeneratedCriteria {
        ...
        public Criteria andLogicalDeleted(boolean deleted) {
            return deleted ? andDeletedEqualTo(LitemallTopic.Deleted.IS_DELETED.value())
        ...
        public interface ICriteriaAdd {
             ...
             * the database table litemall_topic
             *
             * @mbg.generated
             */
    ...
    public interface IExampleWhen {
         ...
         * @mbg.generated
         */
        void example(com.little.g.springcloud.mall.model.LitemallTopicExample example);
