...
public interface LitemallOrderMapper {
     ...
     * @mbg.generated
     */
    LitemallOrder selectByPrimaryKeyWithLogicalDelete(@Param("id") Integer id,
     ...
     * @mbg.generated
     */
    int updateByExampleSelective(@Param("record") LitemallOrder record,
                                 @Param("example") LitemallOrderExample example);
     ...
     * @mbg.generated
     */
    int updateByExample(@Param("record") LitemallOrder record,
                        @Param("example") LitemallOrderExample example);
