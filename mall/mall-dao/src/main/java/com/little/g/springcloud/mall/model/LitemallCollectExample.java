...
public class LitemallCollectExample {
	...
	public static class Criteria extends GeneratedCriteria {
		...
		public Criteria andLogicalDeleted(boolean deleted) {
			return deleted ? andDeletedEqualTo(LitemallCollect.Deleted.IS_DELETED.value())
		...
		public interface ICriteriaAdd {
			 ...
			 * the database table litemall_collect
			 *
			 * @mbg.generated
			 */
	...
	public interface IExampleWhen {
		 ...
		 * @mbg.generated
		 */
		void example(com.little.g.springcloud.mall.model.LitemallCollectExample example);
