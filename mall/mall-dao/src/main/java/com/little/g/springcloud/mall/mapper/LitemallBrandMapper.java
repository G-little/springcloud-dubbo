...
public interface LitemallBrandMapper {
	 ...
	 * @mbg.generated
	 */
	LitemallBrand selectByPrimaryKeySelective(@Param("id") Integer id,
			@Param("selective") LitemallBrand.Column... selective);
	 ...
	 * @mbg.generated
	 */
	LitemallBrand selectByPrimaryKeyWithLogicalDelete(@Param("id") Integer id,
	 ...
	 * @mbg.generated
	 */
	int updateByExampleSelective(@Param("record") LitemallBrand record,
			@Param("example") LitemallBrandExample example);
	 ...
	 * @mbg.generated
	 */
	int updateByExample(@Param("record") LitemallBrand record,
			@Param("example") LitemallBrandExample example);
