...
import com.little.g.springcloud.mall.model.LitemallRole;
import com.little.g.springcloud.mall.model.LitemallRoleExample;
...
public interface LitemallRoleMapper {
	 ...
	 * @mbg.generated
	 */
	LitemallRole selectByPrimaryKeySelective(@Param("id") Integer id,
			@Param("selective") LitemallRole.Column... selective);
	 ...
	 * @mbg.generated
	 */
	LitemallRole selectByPrimaryKeyWithLogicalDelete(@Param("id") Integer id,
	 ...
	 * @mbg.generated
	 */
	int updateByExampleSelective(@Param("record") LitemallRole record,
			@Param("example") LitemallRoleExample example);
	 ...
	 * @mbg.generated
	 */
	int updateByExample(@Param("record") LitemallRole record,
			@Param("example") LitemallRoleExample example);
