...
public interface LitemallCollectMapper {
     ...
     * @mbg.generated
     */
    LitemallCollect selectByPrimaryKeySelective(@Param("id") Integer id,
                                                @Param("selective") LitemallCollect.Column... selective);
     ...
     * @mbg.generated
     */
    LitemallCollect selectByPrimaryKeyWithLogicalDelete(@Param("id") Integer id,
     ...
     * @mbg.generated
     */
    int updateByExampleSelective(@Param("record") LitemallCollect record,
                                 @Param("example") LitemallCollectExample example);
     ...
     * @mbg.generated
     */
    int updateByExample(@Param("record") LitemallCollect record,
                        @Param("example") LitemallCollectExample example);
