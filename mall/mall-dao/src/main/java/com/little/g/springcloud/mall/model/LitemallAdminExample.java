...
public class LitemallAdminExample {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        protected void addRoleIdsCriterion(String condition, Object value,
                                           String property) {
            if (value == null) {
                throw new RuntimeException("Value for " + property + " cannot be null");
            }
            roleIdsCriteria.add(new Criterion(condition, value,
                    "com.little.g.springcloud.mall.mybatis.JsonIntegerArrayTypeHandler"));
            allCriteria = null;
        }

        protected void addRoleIdsCriterion(String condition, Integer[] value1,
                                           Integer[] value2, String property) {
            if (value1 == null || value2 == null) {
                throw new RuntimeException(
                        "Between values for " + property + " cannot be null");
            }
            roleIdsCriteria.add(new Criterion(condition, value1, value2,
                    "com.little.g.springcloud.mall.mybatis.JsonIntegerArrayTypeHandler"));
            allCriteria = null;
        }
        ...
        public Criteria andRoleIdsEqualToColumn(LitemallAdmin.Column column) {
            addCriterion(new StringBuilder("role_ids = ")
                    .append(column.getEscapedColumnName()).toString());
            return (Criteria) this;
        }
        ...
        public Criteria andRoleIdsGreaterThanOrEqualToColumn(
                LitemallAdmin.Column column) {
            addCriterion(new StringBuilder("role_ids >= ")
                    .append(column.getEscapedColumnName()).toString());
            return (Criteria) this;
    ...
    public static class Criteria extends GeneratedCriteria {
        ...
        public Criteria andLogicalDeleted(boolean deleted) {
            return deleted ? andDeletedEqualTo(LitemallAdmin.Deleted.IS_DELETED.value())
    ...
    public interface IExampleWhen {
         ...
         * @mbg.generated
         */
        void example(com.little.g.springcloud.mall.model.LitemallAdminExample example);
