...
public interface LitemallAdMapper {
     ...
     * @mbg.generated
     */
    LitemallAd selectOneByExampleSelective(@Param("example") LitemallAdExample example,
     ...
     * @mbg.generated
     */
    List<LitemallAd> selectByExampleSelective(@Param("example") LitemallAdExample example,
                                              @Param("selective") LitemallAd.Column... selective);
     ...
     * @mbg.generated
     */
    LitemallAd selectByPrimaryKeySelective(@Param("id") Integer id,
                                           @Param("selective") LitemallAd.Column... selective);
     ...
     * @mbg.generated
     */
    LitemallAd selectByPrimaryKeyWithLogicalDelete(@Param("id") Integer id,
     ...
     * @mbg.generated
     */
    int updateByExampleSelective(@Param("record") LitemallAd record,
     ...
     * @mbg.generated
     */
    int updateByExample(@Param("record") LitemallAd record,
                        @Param("example") LitemallAdExample example);
