...
public class HomeController {
    ...
    public Object index(@LoginUser Integer userId) {
        ...
        Callable<List<LitemallCategoryDTO>> channelListCallable = () -> categoryService.queryChannel();
        ...
        Callable<List<LitemallGoodsDTO>> newGoodsListCallable = () -> goodsService.queryByNew(0,
                SystemConfig.getNewLimit());

        Callable<List<LitemallGoodsDTO>> hotGoodsListCallable = () -> goodsService.queryByHot(0,
        ...
        Callable<List<LitemallTopicDTO>> topicListCallable = () -> topicService.queryList(0,
        ...
        FutureTask<List<LitemallCategoryDTO>> channelTask = new FutureTask<>(channelListCallable);
        FutureTask<List<LitemallCouponDTO>> couponListTask = new FutureTask<>(couponListCallable);
        FutureTask<List<LitemallGoodsDTO>> newGoodsListTask = new FutureTask<>(newGoodsListCallable);
        FutureTask<List<LitemallGoodsDTO>> hotGoodsListTask = new FutureTask<>(hotGoodsListCallable);
        FutureTask<PageInfo<LitemallBrandDTO>> brandListTask = new FutureTask<>(
                brandListCallable);
        FutureTask<List<LitemallTopicDTO>> topicListTask = new FutureTask<>(topicListCallable);
        FutureTask<PageInfo<GrouponRuleVo>> grouponListTask = new FutureTask<>(
                grouponListCallable);
        FutureTask<List<IndexCategoryVo>> floorGoodsListTask = new FutureTask<>(floorGoodsListCallable);
