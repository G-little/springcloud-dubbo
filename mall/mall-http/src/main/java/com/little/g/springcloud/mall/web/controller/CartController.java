...
public class CartController {
	 ...
	 */
	@PostMapping("add")
	public Object add(@LoginUser Integer userId, @RequestBody LitemallCartDTO cart) {
		if (userId == null) {
			return ResponseUtil.unlogin();
		}
		if (cart == null) {
	 ...
	 */
	@PostMapping("fastadd")
	public Object fastadd(@LoginUser Integer userId, @RequestBody LitemallCartDTO cart) {
		if (userId == null) {
			return ResponseUtil.unlogin();
		}
		if (cart == null) {
	 ...
	 */
	@PostMapping("update")
	public Object update(@LoginUser Integer userId, @RequestBody LitemallCartDTO cart) {
		if (userId == null) {
			return ResponseUtil.unlogin();
		}
		Integer productId = cart.getProductId();
