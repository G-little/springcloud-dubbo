...
public class GoodsController {
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "brandId", value = "品牌商ID", dataType = "Integer",
                    required = false),
            @ApiImplicitParam(name = "categoryId", value = "分类类目ID，可选",
                    dataType = "Integer", required = false),
            @ApiImplicitParam(name = "brandId", value = "品牌商I", dataType = "Integer",
                    required = false),
    ...
    @GetMapping("list")
    public ResultJson<GoodsSearchPageResultVo> list(Integer categoryId, Integer brandId, String keyword, Boolean isNew,
        ...
        GoodsSearchPageResultVo vo = Page.newInstance(goodsList, GoodsSearchPageResultVo.class);
