...
public class AftersaleController {
    ...
    @ApiImplicitParams({@ApiImplicitParam(name = "status",
            ...
            defaultValue = "0",
            allowableValues = "0,1,2,3,4,5", required = true, dataType = "byte", example = "0"),
            @ApiImplicitParam(name = "page", value = "分页", defaultValue = "1", dataType = "int", example = "1"),
            @ApiImplicitParam(name = "limit", value = "单页条数", defaultValue = "10", dataType = "int", example = "10")})
    @GetMapping("list")
    ...
    @ApiImplicitParams({@ApiImplicitParam(name = "id", value = "售后单ID",
            dataType = "int", required = true, example = "1")})
    @PostMapping("cancel")
