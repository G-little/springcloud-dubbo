...
public class CouponController {
    ...
    @GetMapping("list")
    public ResultJson<Page<LitemallCouponDTO>> list(@RequestParam(defaultValue = "1") Integer page,
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "grouponRulesId", value = "团购规则ID", required = false)
    })
    public ResultJson<Page<CouponVo>> selectlist(@LoginUser Integer userId, Integer cartId,
