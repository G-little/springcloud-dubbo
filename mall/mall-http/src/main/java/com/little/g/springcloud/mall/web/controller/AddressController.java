...
public class AddressController extends GetRegionManager {
    ...
    @ApiImplicitParams({@ApiImplicitParam(name = "id", value = "地址id", required = true)})
    @GetMapping("detail")
    ...
    @ApiImplicitParams({@ApiImplicitParam(name = "id", dataType = "int", defaultValue = "1", example = "1", value = "地址id", required = true)})
    @PostMapping("delete")
