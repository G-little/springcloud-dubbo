...
public class OrderController {
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "showType", value = "显示类型，0，全部订单； 1，待付款； 2，待发货； 3，待收货； 4，待评价。 ", dataType = "Integer",
    ...
    @ApiOperation("订单详情")
    @GetMapping("detail")
    public ResultJson<OrderDetailVo> detail(@LoginUser Integer userId, @NotNull Integer orderId) {
