...
public class OrderController {
     ...
     */
    @ApiOperation("订单详情")
    @ApiImplicitParam("订单信息，{ cartId：xxx, addressId: xxx, couponId: xxx, message: xxx,grouponRulesId: xxx, grouponLinkId: xxx}")
    @PostMapping("submit")
    public ResultJson submit(@LoginUser Integer userId, @RequestBody String body) {
